...
CREATE TABLE `security_role` (
  ...
  `key` varchar(64) DEFAULT NULL COMMENT '角色key',
...
INSERT INTO security_role(id,`key`,name,description,createTime,modifyTime,status) VALUES(2,'admin','超级管理员','超级管理员','2021-03-11 07:15:44','2021-03-11 07:15:44',1),(3,'company','公司管理员','公司管理员','2021-03-11 07:16:28','2021-03-11 07:16:28',1),(4,'editor','普通用户','普通用户','2021-03-11 07:16:48','2021-03-11 07:52:10',1);
INSERT INTO security_role_route(roleId,routeId) VALUES(2,2),(2,3),(3,2);
...
INSERT INTO security_user(id,username,password,avatar,email,introduction,createTime,modifyTime,status,name) VALUES(2,'admin','admin','https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif','772333621@qq.com','技术宅男','2021-03-11 06:37:30','2021-03-11 08:25:57',1,'name_admin');
INSERT INTO security_user_role(userId,roleId) VALUES(2,2);
